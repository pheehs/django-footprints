onUHClick = function(pk){
	...
	if(request.readyState == 4 && request.status == 200) {
		...
		createStringPlacemark(in_lon, in_lat, out_lon, out_lat);
	    }
	}
    }
...
function createStringPlacemark(in_lon, in_lat, out_lon, out_lat) {
    // Create the placemark
    var linePlacemark = ge.createPlacemark("");
